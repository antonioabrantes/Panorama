...
class AnaliseJurisprudencia(models.Model):
    ...
    historico_pedido = models.JSONField(default=list)
    resumo_pedido = models.JSONField(default=list)
    resumo_recurso = models.JSONField(default=list)
    comparacao_docs = models.JSONField(default=list) 
